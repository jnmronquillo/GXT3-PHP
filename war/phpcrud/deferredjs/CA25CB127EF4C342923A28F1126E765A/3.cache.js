...
function $html1(arg0, arg1, arg2, arg3, arg4){
  ...
  sb.impl.string += "'> <div>First Project<\/div> <\/div> <div class='";
  $append_10(sb, htmlEscape(arg1));
  sb.impl.string += "'> <span class='";
  $append_10(sb, htmlEscape(arg2));
  sb.impl.string += "'> <a class='";
  $append_10(sb, htmlEscape(arg3));
  sb.impl.string += "' href='/logout'> <span class='";
  $append_10(sb, htmlEscape(arg4));
  sb.impl.string += "'>Logout<\/span> <\/a> <\/span> <\/div>";
...
defineSeed(507, 5, {}, RevealRootContentEvent_0);
...
defineSeed(623, 609, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$Store, Q$TreeStore]), TreeStore_0);
...
defineSeed(624, 1, {}, TreeStore$1_0);
...
defineSeed(625, 1, makeCastMap([Q$TreeStore$TreeModel]), TreeStore$TreeModel_0);
_.data = null;
_.isVisible = true;
_.parent_0 = null;
_.root = false;
...
defineSeed(626, 627, {}, StoreAddEvent_0);
...
defineSeed(635, 632, makeCastMap([Q$TreeStoreRemoveEvent]), TreeStoreRemoveEvent_0);
_.children_0 = null;
_.parent_0 = null;
defineSeed(728, 1, {});
_.style_0 = null;
function ViewportDefaultAppearance_0(){
  ensureInjected(($clinit_ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$styleInitializer() , style_7));
}

defineSeed(741, 1, {}, ViewportDefaultAppearance_0);
var style_7 = null;
function ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(743, 1, {}, ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0);
...
function $clinit_ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$styleInitializer(){
  ...
  style_7 = new ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0;
}

function $template_2(){
  var outer_0, sb;
  outer_0 = (sb = new StringBuilder_0 , sb.impl.string += '<div class="' , $append_10(sb, htmlEscape('GN1NA3IBJQ')) , sb.impl.string += '"><\/div>' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string));
  return outer_0;
}
...
function $onCheckChange(node, checkElement, checkable, state){
  ...
  if (checkable) {
    switch (state) {
      case 0:
        e = $getImage(($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$checkedInitializer() , checked_4));
        break;
      case 2:
        e = $getImage(($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$uncheckedInitializer() , unchecked_3));
        break;
      case 1:
...
function $renderNode(sb, id, text, icon, checkable, checked, joint, level){
  ...
  $append_10(sb.sb, '<div class="GN1NA3IBIOB">');
  ...
  $appendHtmlConstant(sb, !jointElement?'<img src="' + blankImageUrl + '" style="width: 16px" class="GN1NA3IBKOB" />':$toString_0(jointElement));
  if (checkable) {
    e = null;
    switch (checked) {
      case 0:
    ...
    $addClassName(e, 'GN1NA3IBEOB');
    $appendHtmlConstant(sb, $toString_0(e));
  }
   else {
    $append_10(sb.sb, "<span class='GN1NA3IBEOB'><\/span>");
  }
  if (icon) {
    ...
    $append_10(sb.sb, '<span class="GN1NA3IBJOB"><\/span>');
  }
...
defineSeed(934, 728, {}, BlueBorderLayoutAppearance_0);
var css_6 = null;
...
defineSeed(936, 1, {}, BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1_0);
...
function BlueTreeAppearance_0(){
  this.style_0 = ($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$styleInitializer() , style_50);
  $ensureInjected_9(this.style_0);
}

defineSeed(1103, 913, {}, BlueTreeAppearance_0);
var checked_4 = null, folderClosed = null, folderOpened = null, jointCollapsedIcon = null, jointExpandedIcon = null, partialChecked = null, style_50 = null, unchecked_3 = null;
...
defineSeed(1105, 1, {}, BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1_0);
...
function $clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$styleInitializer(){
  ...
  style_50 = new BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1_0;
}
...
defineSeed(1207, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$3_0);
...
defineSeed(1208, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$4_0);
...
defineSeed(1209, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$5_0);
...
defineSeed(1210, 1, makeCastMap([Q$EventHandler, Q$SplitBarDragEvent$SplitBarDragHandler]), BorderLayoutContainer$6_0);
_.this$0 = null;
_.val$c = null;
_.val$data = null;
_.val$fbar = null;
...
defineSeed(1212, 1, makeCastMap([Q$HasMargins]), MarginData_0);
function BorderLayoutContainer$Handler_0(this$0){
  this.this$0 = this$0;
}

defineSeed(1213, 1, makeCastMap([Q$EventHandler, Q$BeforeCollapseEvent$BeforeCollapseHandler, Q$BeforeExpandEvent$BeforeExpandHandler]), BorderLayoutContainer$Handler_0);
_.this$0 = null;
...
function Viewport_1(){
  ...
  $append_5(sb, $template_2($clinit_ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$styleInitializer()));
...
defineSeed(1236, 5, makeCastMap([Q$CancellableEvent]), BeforeCollapseItemEvent_0);
...
defineSeed(1238, 5, makeCastMap([Q$CancellableEvent]), BeforeExpandItemEvent_0);
...
defineSeed(1250, 5, {}, CheckChangedEvent_0);
...
function $isRightClick(this$static){
  if ($eventGetButton(this$static) == 2 || ($clinit_GXT() , dynamicCast(com_sencha_gxt_core_client_GXT_OS(), Q$GXT$OS).isMac()) && !!this$static.ctrlKey) {
    return true;
  }
  return false;
}
...
function $within(this$static, element){
  ...
  if (!!element && element.nodeType == 1) {
    ...
    if (is_1(target)) {
      return $isOrHasChild(element, target);
    }
  }
  return false;
}
...
function $ensureFocusElement(this$static){
  ...
  this$static.focusEl = $appendChild(this$static.element, createFocusable0(focusHandler_0?focusHandler_0:(focusHandler_0 = $createFocusHandler())));
...
function $focus_1(this$static){
  $clinit_GXT();
  dynamicCast(com_sencha_gxt_core_client_GXT_UserAgent(), Q$GXT$UserAgent).isGecko1_8() || dynamicCast(com_sencha_gxt_core_client_GXT_UserAgent(), Q$GXT$UserAgent).isGecko1_9()?$scheduleDeferred(($clinit_SchedulerImpl() , INSTANCE_4), new Tree$1_0(this$static)):!!this$static.focusEl && (this$static.focusEl.focus() , undefined);
}
...
function $getCellContent(this$static, model){
  ...
  $append_5(sb, text == null || $equals_3('', text)?($clinit_SafeHtmlUtils() , new SafeHtmlString_0('&#160;')):($clinit_SafeHtmlUtils() , new SafeHtmlString_0(htmlEscape(text))));
...
function $onAdd_0(this$static, event_0){
  ...
  if (this$static.eventsToSink == -1) {
    ...
    if (!parent_0 || !!pn && pn.childrenRendered) {
      ...
      for (child$iterator = new AbstractList$IteratorImpl_0(event_0.items); child$iterator.i < child$iterator.this$0_0.size_1();) {
        child = $next_3(child$iterator);
        $append_5(sb, $renderChild(this$static, child, parentDepth));
      }
      ...
      index == 0?insertFirst($getContainer(this$static, parent_0), (new SafeHtmlString_0(sb.sb.impl.string)).html):index == parentChildCount - 1?insertHtml('beforeEnd', $getContainer(this$static, parent_0), (new SafeHtmlString_0(sb.sb.impl.string)).html):insertBefore($getChild($getContainer(this$static, parent_0), index), (new SafeHtmlString_0(sb.sb.impl.string)).html);
    }
...
function $onClick_4(this$static, event_0){
  ...
  e = event_0;
  node = $findNode(this$static, event_0.target);
  if (node) {
    ...
    this$static.checkable && !!checkEl && $within(e, checkEl) && (event_0.stopPropagation() , event_0.preventDefault() , $setChecked_1(this$static, node.model, node.checked_0 == 0 || node.checked_0 == 1?2:0) , undefined);
  }
  $ensureFocusElement(this$static);
...
function $renderChildren(this$static, parent_0){
  ...
  for (i = 0; i < children.coll.size_1(); ++i) {
    $append_5(markup, $renderChild(this$static, $get_10(children.list, i), depth));
  }
  container = $getContainer(this$static, parent_0);
  $setInnerHTML(container, (new SafeHtmlString_0(markup.sb.impl.string)).html);
  for (i = 0; i < children.coll.size_1(); ++i) {
...
function $scrollIntoView_1(this$static, model){
  ...
  if (node) {
    ...
    if (con) {
      $scrollIntoView(con);
      $setXY(this$static.focusEl, new Point_0($getAbsoluteLeft_0(con), $getAbsoluteTop(con)));
    }
  }
}
...
function Tree_1(store, valueProvider){
  ...
  builder = new SafeHtmlBuilder_0;
  $append_10(builder.sb, '<div class=GN1NA3IBPOB><\/div>');
  $setElement(this, ($clinit_XDOM() , create_3((new SafeHtmlString_0(builder.sb.impl.string)).html)));
...
_.onAfterFirstAttach = function onAfterFirstAttach_10(){
  var builder;
  builder = new SafeHtmlBuilder_0;
  $append_10(builder.sb, "<div class='GN1NA3IBFOB' role='group'><\/div>");
  $setInnerHTML(this.element, (new SafeHtmlString_0(builder.sb.impl.string)).html);
  $show_0(this.element);
  ...
  this.eventsToSink == -1?$sinkEvents(this.element, 17407 | (this.element.__eventBits || 0)):(this.eventsToSink |= 17407);
}
;
...
_.onBrowserEvent = function onBrowserEvent_22(event_0){
  ...
  switch ($eventGetTypeInt(event_0.type)) {
    case 1:
      ...
      break;
    case 2:
      node = $findNode(this, event_0.target);
...
defineSeed(1408, 1, makeCastMap([Q$EventHandler, Q$StoreAddEvent$StoreAddHandler, Q$StoreDataChangeEvent$StoreDataChangeHandler, Q$StoreFilterEvent$StoreFilterHandler, Q$StoreRemoveEvent$StoreRemoveHandler]), Tree$Handler_0);
...
defineSeed(1409, 1, makeCastMap([Q$Tree$TreeNode]), Tree$TreeNode_0);
_.checkElement = null;
_.checked_0 = 2;
...
function $onMouseClick(this$static, e){
  ...
  if (this$static.selectionMode == 2) {
    node = $findNode(this$static.tree, e.target);
...
defineSeed(1410, 1315, makeCastMap([Q$HasHandlers, Q$StoreSelectionModel]), TreeSelectionModel_0);
...
defineSeed(1411, 588, {}, TreeSelectionModel$1_0);
...
defineSeed(1412, 1, makeCastMap([Q$ClickHandler, Q$MouseDownHandler, Q$EventHandler]), TreeSelectionModel$Handler_0);
...
function $getContainer_0(node){
  ...
  if (!node.containerElement) {
    sb = new SafeHtmlBuilder_0;
    $append_10(sb.sb, "<div class='GN1NA3IBFOB' role='group'><\/div>");
    $setContainerElement(node, $appendChild((!node.element && (node.element = $getElementById($doc, node.id_0)) , node.element), ($clinit_XDOM() , create_3((new SafeHtmlString_0(sb.sb.impl.string)).html))));
  }
...
function $onIconStyleChange(node, icon){
  ...
  if (iconEl) {
    icon?(e = $createElement_0(new ClippedImagePrototype_0(icon.url, icon.left_0, icon.top_0, icon.width_0, icon.height_0))):(e = $doc.createElement('span'));
...
function $onMouseOver_1(this$static, ne){
  var node;
  node = $getNode(this$static, ne.target);
  if (node) {
...
defineSeed(1472, 466, makeCastMap([Q$Collection, Q$List]));
...
defineSeed(1503, 1472, makeCastMap([Q$Serializable, Q$Collection, Q$List]), LinkedList_0, LinkedList_1);
...
defineSeed(1504, 1, makeCastMap([Q$Iterator, Q$ListIterator]), LinkedList$ListIteratorImpl_0);
...
defineSeed(1505, 1, {}, LinkedList$Node_0, LinkedList$Node_1);
_.next = null;
_.prev = null;
_.value_0 = null;
var Lcom_crud_client_presenter_LayoutPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'LayoutPresenter', 16), Lcom_crud_client_presenter_MenuPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter', 22), Lcom_crud_client_presenter_MenuPresenter$1_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter$1', 23), Lcom_crud_client_view_LayoutView_2_classLit = createForClass('com.crud.client.view.', 'LayoutView', 63), Lcom_gwtplatform_mvp_client_proxy_RevealRootContentEvent_2_classLit = createForClass('com.gwtplatform.mvp.client.proxy.', 'RevealRootContentEvent', 507), Lcom_crud_client_view_MenuView_2_classLit = createForClass('com.crud.client.view.', 'MenuView', 67), Lcom_crud_client_view_MenuView$KeyProvider_2_classLit = createForClass('com.crud.client.view.', 'MenuView$KeyProvider', 69), Lcom_crud_client_view_MenuView$1_2_classLit = createForClass('com.crud.client.view.', 'MenuView$1', 68), Lcom_crud_client_view_LayoutView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl', 64), Lcom_crud_client_view_LayoutView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl$Widgets', 65), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator', 44), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator$1', 45), Lcom_sencha_gxt_data_shared_event_StoreAddEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreAddEvent', 626), Lcom_sencha_gxt_data_shared_event_StoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreRemoveEvent', 632), Lcom_sencha_gxt_widget_core_client_container_Viewport_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'Viewport', 1230), Lcom_crud_client_view_MenuView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl', 70), Lcom_crud_client_view_MenuView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl$Widgets', 71), Lcom_sencha_gxt_data_shared_TreeStore_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore', 623), Lcom_sencha_gxt_data_shared_TreeStore$TreeModel_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$TreeModel', 625), Lcom_sencha_gxt_data_shared_TreeStore$1_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$1', 624), Lcom_crud_client_util_MenuDto_2_classLit = createForClass('com.crud.client.util.', 'MenuDto', 62), Lcom_sencha_gxt_widget_core_client_tree_Tree_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree', 1406), Lcom_sencha_gxt_widget_core_client_tree_Tree$TreeNode_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$TreeNode', 1409), Lcom_sencha_gxt_widget_core_client_tree_Tree$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$Handler', 1408), Lcom_sencha_gxt_widget_core_client_tree_Tree$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$1', 1407), Lcom_sencha_gxt_widget_core_client_event_BeforeExpandItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeExpandItemEvent', 1238), Lcom_sencha_gxt_widget_core_client_event_BeforeCollapseItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeCollapseItemEvent', 1236), Lcom_sencha_gxt_widget_core_client_event_CheckChangedEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'CheckChangedEvent', 1250), Lcom_sencha_gxt_widget_core_client_tree_TreeStyle_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeStyle', 1413), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel', 1410), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$Handler', 1412), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$1', 1411), Lcom_sencha_gxt_theme_base_client_tree_TreeBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.tree.', 'TreeBaseAppearance', 913), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance', 1103), Ljava_util_AbstractSequentialList_2_classLit = createForClass('java.util.', 'AbstractSequentialList', 1472), Ljava_util_LinkedList_2_classLit = createForClass('java.util.', 'LinkedList', 1503), Ljava_util_LinkedList$ListIteratorImpl_2_classLit = createForClass('java.util.', 'LinkedList$ListIteratorImpl', 1504), Ljava_util_LinkedList$Node_2_classLit = createForClass('java.util.', 'LinkedList$Node', 1505), Lcom_sencha_gxt_data_shared_event_TreeStoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'TreeStoreRemoveEvent', 635), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_1BlueTreeResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1', 1105), Lcom_sencha_gxt_widget_core_client_tree_TreeView_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeView', 1414), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance', 741), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_1ViewportResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1', 743), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer', 1204), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$Handler', 1213), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$3_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$3', 1207), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$4_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$4', 1208), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$5_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$5', 1209), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$6_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$6', 1210), Lcom_google_gwt_uibinder_client_LazyDomElement_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'LazyDomElement', 337), Lcom_google_gwt_event_dom_client_ClickEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'ClickEvent', 258), Lcom_google_gwt_uibinder_client_UiBinderUtil$TempAttachment_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'UiBinderUtil$TempAttachment', 339), Lcom_sencha_gxt_theme_base_client_container_BorderLayoutBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'BorderLayoutBaseAppearance', 728), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance', 934), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_1BlueBorderLayoutResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1', 936);
$entry(onLoad_1)(3);
