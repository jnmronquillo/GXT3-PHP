...
defineSeed(259, 260, {}, ClickEvent_0);
...
function $getImage(ir){
  return $createElement(new ClippedImagePrototype_0(ir.url, ir.left_0, ir.top_0, ir.width_0, ir.height_0));
}
...
function $scrollIntoView_1(this$static, model){
  ...
  if (node) {
    ...
    if (con) {
      $scrollIntoView(con);
      $setXY(this$static.focusEl, new Point_0($getAbsoluteLeft(con), $getBoundingClientRectTop(con) + $wnd.pageYOffset));
    }
  }
}
    ...
    case 2:
      ...
      if (!!e.shiftKey && this$static.lastSelected != null) {
        ...
        if (!!(!selNode.element && (selNode.element = $getElementById($doc, selNode.id_0)) , selNode.element) && !!(!itemNode.element && (itemNode.element = $getElementById($doc, itemNode.id_0)) , itemNode.element)) {
          if ($getBoundingClientRectTop((!selNode.element && (selNode.element = $getElementById($doc, selNode.id_0)) , selNode.element)) + $wnd.pageYOffset < $getBoundingClientRectTop((!itemNode.element && (itemNode.element = $getElementById($doc, itemNode.id_0)) , itemNode.element)) + $wnd.pageYOffset) {
            next = $next_2(this$static);
            while (next != null) {
...
function $onIconStyleChange(node, icon){
  ...
  if (iconEl) {
    icon?(e = $createElement(new ClippedImagePrototype_0(icon.url, icon.left_0, icon.top_0, icon.width_0, icon.height_0))):(e = $doc.createElement('span'));
...
defineSeed(1441, 471, makeCastMap([Q$Collection, Q$List]));
