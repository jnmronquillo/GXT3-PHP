...
defineSeed(252, 251, {}, DirtCollector_0);
...
defineSeed(253, 251, {}, ErrorCollector_0);
...
defineSeed(255, 256, {}, Initializer_0);
...
defineSeed(257, 83, {}, RootEditorContext_0);
...
defineSeed(258, 1, makeCastMap([Q$EditorError, Q$SimpleError]), SimpleError_0);
...
defineSeed(292, 293, {}, Request$1_0);
...
defineSeed(294, 130, makeCastMap([Q$Timer]), Request$3_0);
...
defineSeed(295, 1, {}, RequestBuilder_0);
_.httpMethod = null;
_.timeoutMillis = 0;
_.url = null;
var POST, PUT;
...
defineSeed(296, 1, {}, RequestBuilder$1_0);
...
defineSeed(297, 1, {}, RequestBuilder$Method_0);
...
defineSeed(298, 144, makeCastMap([Q$RequestException, Q$Serializable, Q$Exception, Q$Throwable]), RequestException_0);
...
defineSeed(299, 298, makeCastMap([Q$RequestException, Q$Serializable, Q$Exception, Q$Throwable]), RequestPermissionException_0);
function RequestTimeoutException_0(timeoutMillis){
  $fillInStackTrace();
  this.detailMessage = 'A request timeout has expired after ' + timeoutMillis + ' ms';
}

defineSeed(300, 298, makeCastMap([Q$RequestException, Q$Serializable, Q$Exception, Q$Throwable]), RequestTimeoutException_0);
...
defineSeed(303, 1, makeCastMap([Q$EventHandler, Q$HasDirectionEstimator]), AutoDirectionHandler_0);
...
defineSeed(305, 191, makeCastMap([Q$HasDirection$Direction, Q$Serializable, Q$Comparable, Q$Enum]), HasDirection$Direction_0);
...
defineSeed(337, 1, {}, PassthroughParser_0);
var INSTANCE_5 = null;
function PassthroughRenderer_0(){
}

defineSeed(338, 336, {}, PassthroughRenderer_0);
var INSTANCE_6 = null;
...
defineSeed(375, 1, makeCastMap([Q$HasDirectionEstimator]), DirectionalTextHelper_0);
_.element = null;
...
defineSeed(377, 369, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget]));
...
defineSeed(376, 377, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget]), FlexTable_0);
...
defineSeed(378, 379, {}, FlexTable$FlexCellFormatter_0);
defineSeed(380, 97, makeCastMap([Q$HasKeyDownHandlers, Q$HasKeyPressHandlers, Q$HasKeyUpHandlers, Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasEnabled, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]));
...
defineSeed(383, 97, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$HasDirectionEstimator, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]));
_.directionalTextHelper = null;
defineSeed(382, 383, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$HasDirection, Q$HasDirectionEstimator, Q$EventListener, Q$HasText, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]));
...
defineSeed(385, 1, makeCastMap([Q$Iterator]), HTMLTable$1_0);
...
defineSeed(386, 1, {}, HTMLTable$ColumnFormatter_0);
_.columnGroup = null;
_.this$0 = null;
...
defineSeed(387, 1, {}, HTMLTable$RowFormatter_0);
_.this$0 = null;
...
defineSeed(396, 381, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$HasDirection, Q$HasDirectionEstimator, Q$EventListener, Q$HasText, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), InlineHTML_0);
...
defineSeed(408, 409, makeCastMap([Q$HasChangeHandlers, Q$HasKeyDownHandlers, Q$HasKeyPressHandlers, Q$HasKeyUpHandlers, Q$HasAttachHandlers, Q$HasValueChangeHandlers, Q$HasHandlers, Q$AutoDirectionHandler$Target, Q$HasDirection, Q$HasDirectionEstimator, Q$EventListener, Q$TakesValue, Q$HasEnabled, Q$HasName, Q$HasText, Q$HasValue, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]));
...
defineSeed(410, 191, makeCastMap([Q$ValueBoxBase$TextAlignment, Q$Serializable, Q$Comparable, Q$Enum]));
var $VALUES_7, CENTER_0, JUSTIFY_0, LEFT_0, RIGHT_0;
function ValueBoxBase$TextAlignment$1_0(){
  Enum_0.call(this, 'CENTER', 0);
}

defineSeed(411, 410, makeCastMap([Q$ValueBoxBase$TextAlignment, Q$Serializable, Q$Comparable, Q$Enum]), ValueBoxBase$TextAlignment$1_0);
function ValueBoxBase$TextAlignment$2_0(){
  Enum_0.call(this, 'JUSTIFY', 1);
}

defineSeed(412, 410, makeCastMap([Q$ValueBoxBase$TextAlignment, Q$Serializable, Q$Comparable, Q$Enum]), ValueBoxBase$TextAlignment$2_0);
function ValueBoxBase$TextAlignment$3_0(){
  Enum_0.call(this, 'LEFT', 2);
}

defineSeed(413, 410, makeCastMap([Q$ValueBoxBase$TextAlignment, Q$Serializable, Q$Comparable, Q$Enum]), ValueBoxBase$TextAlignment$3_0);
function ValueBoxBase$TextAlignment$4_0(){
  Enum_0.call(this, 'RIGHT', 3);
}

defineSeed(414, 410, makeCastMap([Q$ValueBoxBase$TextAlignment, Q$Serializable, Q$Comparable, Q$Enum]), ValueBoxBase$TextAlignment$4_0);
...
defineSeed(435, 191, makeCastMap([Q$ValueCodex$Type, Q$Serializable, Q$Comparable, Q$Enum]));
_.defaultValue = null;
...
defineSeed(457, 143, makeCastMap([Q$AutoBeanCodexImpl$HaltException, Q$Serializable, Q$Exception, Q$RuntimeException, Q$Throwable]), AutoBeanCodexImpl$HaltException_0);
...
defineSeed(532, 1, {}, IdentityValueProvider_0);
...
defineSeed(651, 432, {}, AutoBeanWriter$1_0);
...
function TipDefaultAppearance_0(){
  TipDefaultAppearance_1.call(this, new TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator_0);
}
...
function TextFieldDefaultAppearance_0(){
  TextFieldDefaultAppearance_1.call(this, $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator());
}

function TextFieldDefaultAppearance_1(){
  this.style_0 = ($clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$cssInitializer() , $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator() , css_1);
  ensureInjected(this.style_0);
}

defineSeed(778, 779, {}, TextFieldDefaultAppearance_0);
function $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator(){
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator = nullMethod;
  externalImage = $moduleBase + '2659A66C9CEC1586DA091ACEC4A3AE6B.cache.png';
}

function $cssInitializer(){
  css_1 = new TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$1_0;
}

var css_1 = null, externalImage, invalidLine = null, textBackground = null;
function TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(781, 1, {}, TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$1_0);
_.getText = function getText_12(){
  return 'input.GN1NA3IBMHC,textarea.GN1NA3IBMHC{border:1px solid #7eadd9;}input.GN1NA3IBNHC,textarea.GN1NA3IBNHC{height:' + ($clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$invalidLineInitializer() , ($clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator() , invalidLine).height_0) + 'px;overflow:hidden;background:url("' + invalidLine.url.uri + '") -' + invalidLine.left_0 + 'px -' + invalidLine.top_0 + 'px  repeat-x;background-color:#fff;background-position:bottom;border:1px solid #c30;height:18px;line-height:18px;}.GN1NA3IBBY{position:relative;left:0;top:0;zoom:1;white-space:nowrap;text-align:left;}.GN1NA3IBLX{font:12px tahoma, arial, helvetica, sans-serif;}.GN1NA3IBKX{color:gray;}.GN1NA3IBAY{height:' + ($clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$textBackgroundInitializer() , textBackground.height_0) + 'px;overflow:hidden;background:url("' + textBackground.url.uri + '") -' + textBackground.left_0 + 'px -' + textBackground.top_0 + 'px  repeat-x;height:auto;background-color:#fff;border:1px #b5b8c8 solid;padding:1px 3px;resize:none;height:18px;line-height:18px;vertical-align:top;}.GN1NA3IBJX{background-color:#fff;border:1px #b5b8c8 solid;padding:1px 3px;resize:none;overflow:visible;}.GN1NA3IBMX{height:18px;line-height:18px;vertical-align:top;}';
}
;
function $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$cssInitializer(){
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$cssInitializer = nullMethod;
  $cssInitializer($clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator());
}

function $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$invalidLineInitializer(){
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$invalidLineInitializer = nullMethod;
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator();
  invalidLine = new ImageResourcePrototype_0(($clinit_UriUtils() , new SafeUriString_0(externalImage)), 4, 3);
}

function $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$textBackgroundInitializer(){
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator$textBackgroundInitializer = nullMethod;
  $clinit_TextFieldDefaultAppearance_TextFieldResources_ie9_default_InlineClientBundleGenerator();
...
function ColumnHeaderDefaultAppearance_0(){
  ColumnHeaderDefaultAppearance_1.call(this, $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator());
}

function ColumnHeaderDefaultAppearance_1(){
  this.style_0 = ($clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator() , style_13);
  ensureInjected(this.style_0);
}

defineSeed(801, 1, {}, ColumnHeaderDefaultAppearance_0);
_.style_0 = null;
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator = nullMethod;
  externalImage_0 = $moduleBase + '60053A3C374CD33DFA7FC43DED4B5AED.cache.png';
}

function $styleInitializer_0(){
  style_13 = new ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnMoveBottomInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnMoveBottomInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnMoveTopInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnMoveTopInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnsIconInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnsIconInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortAscInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortAscInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortAscendingIconInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortAscendingIconInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortDescInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortDescInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortDescendingIconInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortDescendingIconInitializer = nullMethod;
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator();
...
function $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  $styleInitializer_0($clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator());
}
...
function $setStatus_0(parent_0, icon){
  ...
  wrap = $getFirstChildElement(parent_0);
  $setInnerHTML(wrap, '');
  !!icon && $appendChild(wrap, $createElement(new ClippedImagePrototype_0(icon.url, icon.left_0, icon.top_0, icon.width_0, icon.height_0)));
}
...
;
function TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator_0(){
}

defineSeed(876, 1, {}, TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator_0);
_.style_2 = function style_20(){
  return $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , style_19;
}
;
var anchorBottom_1 = null, anchorLeft_1 = null, anchorRight_1 = null, style_19 = null;
function TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(877, 1, {}, TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$1_0);
...
_.getText = function getText_19(){
  return '.GN1NA3IBAOB{padding:2px;font-size:12px;}.GN1NA3IBBOB{float:right;}.GN1NA3IBONB{color:#444;font:bold 11px tahoma, arial, helvetica, sans-serif;}.GN1NA3IBPNB{color:#444;font:11px tahoma, arial, helvetica, sans-serif;}.GN1NA3IBLNB{height:' + ($clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorBottomInitializer() , anchorBottom_1.height_0) + 'px;width:' + anchorBottom_1.width_0 + 'px;overflow:hidden;background:url("' + anchorBottom_1.url.uri + '") -' + anchorBottom_1.left_0 + 'px -' + anchorBottom_1.top_0 + 'px  no-repeat;position:absolute;}.GN1NA3IBNNB{height:' + ($clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorRightInitializer() , anchorRight_1.height_0) + 'px;width:' + anchorRight_1.width_0 + 'px;overflow:hidden;background:url("' + anchorRight_1.url.uri + '") -' + anchorRight_1.left_0 + 'px -' + anchorRight_1.top_0 + 'px  no-repeat;position:absolute;}.GN1NA3IBMNB{height:' + ($clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorLeftInitializer() , anchorLeft_1.height_0) + 'px;width:' + anchorLeft_1.width_0 + 'px;overflow:hidden;background:url("' + anchorLeft_1.url.uri + '") -' + anchorLeft_1.left_0 + 'px -' + anchorLeft_1.top_0 + 'px  no-repeat;position:absolute;}';
}
;
...
;
function $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorBottomInitializer(){
  $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorBottomInitializer = nullMethod;
...
function $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorLeftInitializer(){
  $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorLeftInitializer = nullMethod;
...
function $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorRightInitializer(){
  $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$anchorRightInitializer = nullMethod;
...
function $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  style_19 = new TipDefaultAppearance_TipResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function BlueFieldSetAppearance_0(){
  this.style_0 = ($clinit_BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$cssInitializer() , css_7);
  ensureInjected(this.style_0);
}

defineSeed(921, 775, {}, BlueFieldSetAppearance_0);
var css_7 = null;
function BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(923, 1, {}, BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$1_0);
...
;
function $clinit_BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$cssInitializer(){
  $clinit_BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$cssInitializer = nullMethod;
  css_7 = new BlueFieldSetAppearance_BlueFieldSetResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function BlueCheckMenuItemAppearance_0(){
  BlueCheckMenuItemAppearance_1.call(this, new BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator_0);
}
...
function BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator_0(){
}

defineSeed(932, 1, {}, BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator_0);
_.style_3 = function style_23(){
  return $clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$styleInitializer() , style_22;
}
;
var menuParent = null, style_22 = null;
function BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$2_0(){
}

defineSeed(933, 1, {}, BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$2_0);
_.getText = function getText_28(){
  return 'a.GN1NA3IBPVB{cursor:pointer;display:block;line-height:16px;outline-style:none;outline-width:0;padding:3px 21px 3px 27px;position:relative;text-decoration:none;white-space:nowrap;color:#222;}.GN1NA3IBCWB{white-space:nowrap;display:block;padding:1px;font:normal 11px tahoma, arial, sans-serif;}.GN1NA3IBBWB{border:0 none;height:16px;padding:0;vertical-align:top;width:16px;position:absolute;left:3px;top:3px;margin:0;background-position:center;vertical-align:middle;}.GN1NA3IBAWB{height:' + ($clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$menuParentInitializer() , menuParent.height_0) + 'px;width:' + menuParent.width_0 + 'px;overflow:hidden;background:url("' + menuParent.url.uri + '") -' + menuParent.left_0 + 'px -' + menuParent.top_0 + 'px  no-repeat;height:auto;width:auto;background-position:right;background-repeat:no-repeat;}';
}
;
...
;
function $clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$menuParentInitializer(){
  $clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$menuParentInitializer = nullMethod;
...
function $clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  style_22 = new BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_ie9_ie9_default_InlineClientBundleGenerator$2_0;
}

function BlueFramedPanelAppearance_0(){
  BlueFramedPanelAppearance_1.call(this, new BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator_0);
}
...
;
function BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator_0(){
}

defineSeed(965, 1, {}, BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator_0);
_.style_4 = function style_32(){
  return $clinit_BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , style_31;
}
;
var style_31 = null;
function BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(966, 1, {}, BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$1_0);
...
;
function $clinit_BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  style_31 = new BlueFramedPanelAppearance_BlueFramePanelResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function BlueResizableAppearance_0(){
  this.style_0 = ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , style_39);
  ensureInjected(this.style_0);
}
...
function BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(992, 1, {}, BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$1_0);
_.getText = function getText_38(){
  return '.GN1NA3IBC-B{position:absolute;z-index:100;font-size:1px;line-height:6px;overflow:hidden;opacity:0;}.GN1NA3IBD-B{width:6px;cursor:e-resize;right:0;top:0;height:100%;margin-right:-1px;}.GN1NA3IBH-B{width:100%;cursor:s-resize;left:0;bottom:0;height:6px;margin-bottom:-1px;}.GN1NA3IBK-B{width:6px;cursor:w-resize;left:0;top:0;height:100%;}.GN1NA3IBE-B{width:100%;cursor:n-resize;left:0;top:0;height:6px;}.GN1NA3IBI-B{width:6px;cursor:se-resize;right:0;bottom:0;height:6px;z-index:101;}.GN1NA3IBG-B{width:6px;cursor:nw-resize;left:0;top:0;height:6px;z-index:101;}.GN1NA3IBF-B{width:6px;cursor:ne-resize;right:0;top:0;height:6px;z-index:101;}.GN1NA3IBJ-B{width:6px;cursor:sw-resize;left:0;bottom:0;height:6px;z-index:101;}.GN1NA3IBL-B .GN1NA3IBC-B,.GN1NA3IBN-B .GN1NA3IBC-B{opacity:1;}.GN1NA3IBL-B .GN1NA3IBD-B,.GN1NA3IBN-B .GN1NA3IBD-B,.GN1NA3IBL-B .GN1NA3IBK-B,.GN1NA3IBN-B .GN1NA3IBK-B{background-position:left;}.GN1NA3IBL-B .GN1NA3IBH-B,.GN1NA3IBN-B .GN1NA3IBH-B,.GN1NA3IBL-B .GN1NA3IBE-B,.GN1NA3IBN-B .GN1NA3IBE-B{background-position:top;}.GN1NA3IBL-B .GN1NA3IBI-B,.GN1NA3IBN-B .GN1NA3IBI-B{background-position:top left;}.GN1NA3IBL-B .GN1NA3IBG-B,.GN1NA3IBN-B .GN1NA3IBG-B{background-position:bottom right;}.GN1NA3IBL-B .GN1NA3IBF-B,.GN1NA3IBN-B .GN1NA3IBF-B{background-position:bottom left;}.GN1NA3IBL-B .GN1NA3IBJ-B,.GN1NA3IBN-B .GN1NA3IBJ-B{background-position:top right;}.GN1NA3IBO-B{border:1px dashed;position:absolute;overflow:hidden;display:none;left:0;top:0;z-index:50000;border-color:#3b5a82;}.GN1NA3IBM-B{width:100%;height:100%;display:none;position:absolute;left:0;top:0;z-index:200000;}.GN1NA3IBC-B{opacity:0;background-color:#fff;}.GN1NA3IBL-B .GN1NA3IBD-B,.GN1NA3IBN-B .GN1NA3IBD-B,.GN1NA3IBL-B .GN1NA3IBK-B,.GN1NA3IBN-B .GN1NA3IBK-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleEastInitializer() , handleEast.height_0) + 'px;width:' + handleEast.width_0 + 'px;overflow:hidden;background:url("' + handleEast.url.uri + '") -' + handleEast.left_0 + 'px -' + handleEast.top_0 + 'px  no-repeat;}.GN1NA3IBL-B .GN1NA3IBH-B,.GN1NA3IBN-B .GN1NA3IBH-B,.GN1NA3IBL-B .GN1NA3IBE-B,.GN1NA3IBN-B .GN1NA3IBE-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthInitializer() , handleSouth.height_0) + 'px;width:' + handleSouth.width_0 + 'px;overflow:hidden;background:url("' + handleSouth.url.uri + '") -' + handleSouth.left_0 + 'px -' + handleSouth.top_0 + 'px  no-repeat;}.GN1NA3IBL-B .GN1NA3IBI-B,.GN1NA3IBN-B .GN1NA3IBI-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSoutheastInitializer() , handleSoutheast.height_0) + 'px;width:' + handleSoutheast.width_0 + 'px;overflow:hidden;background:url("' + handleSoutheast.url.uri + '") -' + handleSoutheast.left_0 + 'px -' + handleSoutheast.top_0 + 'px  no-repeat;}.GN1NA3IBL-B .GN1NA3IBG-B,.GN1NA3IBN-B .GN1NA3IBG-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNorthwestInitializer() , handleNorthwest.height_0) + 'px;width:' + handleNorthwest.width_0 + 'px;overflow:hidden;background:url("' + handleNorthwest.url.uri + '") -' + handleNorthwest.left_0 + 'px -' + handleNorthwest.top_0 + 'px  no-repeat;}.GN1NA3IBL-B .GN1NA3IBF-B,.GN1NA3IBN-B .GN1NA3IBF-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNortheastInitializer() , handleNortheast.height_0) + 'px;width:' + handleNortheast.width_0 + 'px;overflow:hidden;background:url("' + handleNortheast.url.uri + '") -' + handleNortheast.left_0 + 'px -' + handleNortheast.top_0 + 'px  no-repeat;}.GN1NA3IBL-B .GN1NA3IBJ-B,.GN1NA3IBN-B .GN1NA3IBJ-B{height:' + ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthwestInitializer() , handleSouthwest.height_0) + 'px;width:' + handleSouthwest.width_0 + 'px;overflow:hidden;background:url("' + handleSouthwest.url.uri + '") -' + handleSouthwest.left_0 + 'px -' + handleSouthwest.top_0 + 'px  no-repeat;}.GN1NA3IBM-B{background-color:#fff;}';
}
;
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleEastInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleEastInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNortheastInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNortheastInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNorthwestInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleNorthwestInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSoutheastInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSoutheastInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthwestInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$handleSouthwestInitializer = nullMethod;
...
function $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  style_39 = new BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function BlueWindowAppearance_0(){
  BlueWindowAppearance_1.call(this, new BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator_0);
}
...
function BlueWindowAppearance_1(resources){
  ...
  $clinit_BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$styleInitializer();
}
...
function BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator_0(){
}

defineSeed(1099, 1, {}, BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator_0);
_.style_4 = function style_49(){
  return $clinit_BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , style_48;
}
;
var style_48 = null;
function BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(1100, 1, {}, BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$1_0);
...
;
function $clinit_BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$styleInitializer(){
  $clinit_BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$styleInitializer = nullMethod;
  style_48 = new BlueWindowAppearance_BlueWindowResources_ie9_default_InlineClientBundleGenerator$1_0;
}
...
function $onKeyPress(this$static, we){
  ...
  t = isOrHasChildImpl(this$static.element, we.target);
...
function $handleMouseDown_0(this$static, event_0, handle){
  ...
  if (this$static.dynamic) {
    ...
    !this$static.proxyEl && (this$static.proxyEl = (elem = $doc.createElement('div') , $addClassName(elem, ($clinit_BlueResizableAppearance_BlueResizableResources_ie9_default_InlineClientBundleGenerator$styleInitializer() , 'GN1NA3IBO-B')) , $disableTextSelection(elem, true) , elem));
    body = getBodyElement();
...
function $setIcon_3(this$static, icon){
  ...
  $appendChild($selectNode(this$static.element, '.GN1NA3IBGQ'), $createElement(new ClippedImagePrototype_0(icon.url, icon.left_0, icon.top_0, icon.width_0, icon.height_0)));
}
...
function $onMouseMove_0(this$static, header, event_0){
  ...
  $setXY(this$static.element, new Point_0(-1, $getBoundingClientRectTop(this$static.this$0.container.element) + $wnd.pageYOffset));
...
function $createContextMenu(this$static, colIndex){
  ...
  if ($isSortable(this$static.cm, colIndex)) {
    ...
    $setIcon_5(item, ($clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortAscendingIconInitializer() , $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator() , sortAscendingIcon));
    ...
    $setIcon_5(item, ($clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$sortDescendingIconInitializer() , sortDescendingIcon));
  ...
  $setIcon_5(columns, ($clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator$columnsIconInitializer() , $clinit_ColumnHeaderDefaultAppearance_ColumnHeaderResources_ie9_default_InlineClientBundleGenerator() , columnsIcon));
...
function $ensureVisible_0(this$static, row, col, hscroll){
  ...
  return cellEl?new Point_0($getAbsoluteLeft(cellEl), $getBoundingClientRectTop(cellEl) + $wnd.pageYOffset):new Point_0($getAbsoluteLeft(c) + $getScrollLeft(c), $getBoundingClientRectTop(rowEl) + $wnd.pageYOffset);
}
...
function $handleComponentEvent(this$static, event_0){
  ...
  if (this$static.trackMouseOver) {
    ...
    switch ($eventGetTypeInt(event_0.type)) {
      ...
      case 32:
        ...
        break;
      case 16384:
        isOrHasChildImpl(this$static.scroller, event_0.target) && $syncScroll(this$static);
    }
  }
  ...
  $eventGetTypeInt(event_0.type) == 16384 && isOrHasChildImpl(this$static.scroller, event_0.target) && $syncScroll(this$static);
}
...
function $position(){
  ...
  if (slots.arrayList.size_0 > 0) {
    ...
    top_0 = $getBoundingClientRectTop(bottom.element) + $wnd.pageYOffset + $getPropertyInt(bottom.element, 'offsetHeight') + 20;
  }
...
defineSeed(1442, 471, makeCastMap([Q$Serializable, Q$Collection, Q$List]));
...
defineSeed(1469, 466, makeCastMap([Q$Collection, Q$Set]), LinkedHashMap$EntrySet_0);
