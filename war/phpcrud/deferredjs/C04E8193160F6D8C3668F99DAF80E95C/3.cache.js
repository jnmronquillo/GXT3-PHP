...
defineSeed(257, 258, {}, ClickEvent_0);
...
defineSeed(336, 1, {}, LazyDomElement_0);
_.domId = null;
_.element = null;
...
defineSeed(338, 1, {}, UiBinderUtil$TempAttachment_0);
_.element = null;
_.origParent = null;
_.origSibling = null;
...
defineSeed(504, 5, {}, RevealRootContentEvent_0);
...
defineSeed(618, 604, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$Store, Q$TreeStore]), TreeStore_0);
...
defineSeed(619, 1, {}, TreeStore$1_0);
...
defineSeed(620, 1, makeCastMap([Q$TreeStore$TreeModel]), TreeStore$TreeModel_0);
_.data = null;
_.isVisible = true;
_.parent_0 = null;
_.root = false;
...
defineSeed(621, 622, {}, StoreAddEvent_0);
...
defineSeed(630, 627, makeCastMap([Q$TreeStoreRemoveEvent]), TreeStoreRemoveEvent_0);
_.children_0 = null;
_.parent_0 = null;
defineSeed(723, 1, {});
_.style_0 = null;
...
defineSeed(736, 1, {}, ViewportDefaultAppearance_0);
var style_6 = null;
function ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(738, 1, {}, ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0);
...
defineSeed(917, 723, {}, BlueBorderLayoutAppearance_0);
var css_6 = null;
...
defineSeed(919, 1, {}, BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1_0);
...
defineSeed(1072, 896, {}, BlueTreeAppearance_0);
...
defineSeed(1074, 1, {}, BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1_0);
...
defineSeed(1176, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$3_0);
...
defineSeed(1177, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$4_0);
...
defineSeed(1178, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$5_0);
...
defineSeed(1179, 1, makeCastMap([Q$EventHandler, Q$SplitBarDragEvent$SplitBarDragHandler]), BorderLayoutContainer$6_0);
_.this$0 = null;
_.val$c = null;
_.val$data = null;
_.val$fbar = null;
...
defineSeed(1181, 1, makeCastMap([Q$HasMargins]), MarginData_0);
function BorderLayoutContainer$Handler_0(this$0){
  this.this$0 = this$0;
}

defineSeed(1182, 1, makeCastMap([Q$EventHandler, Q$BeforeCollapseEvent$BeforeCollapseHandler, Q$BeforeExpandEvent$BeforeExpandHandler]), BorderLayoutContainer$Handler_0);
_.this$0 = null;
...
defineSeed(1205, 5, makeCastMap([Q$CancellableEvent]), BeforeCollapseItemEvent_0);
...
defineSeed(1207, 5, makeCastMap([Q$CancellableEvent]), BeforeExpandItemEvent_0);
...
defineSeed(1219, 5, {}, CheckChangedEvent_0);
...
function $constrainFocusElement_0(this$static){
  ...
  scrollLeft = this$static.element.scrollLeft || 0;
...
function $scrollIntoView_0(this$static, model){
  var con, node;
  node = $findNode_0(this$static, model);
  if (node) {
...
defineSeed(1377, 1, makeCastMap([Q$EventHandler, Q$StoreAddEvent$StoreAddHandler, Q$StoreDataChangeEvent$StoreDataChangeHandler, Q$StoreFilterEvent$StoreFilterHandler, Q$StoreRemoveEvent$StoreRemoveHandler]), Tree$Handler_0);
...
defineSeed(1378, 1, makeCastMap([Q$Tree$TreeNode]), Tree$TreeNode_0);
_.checkElement = null;
_.checked_0 = 2;
...
function $onKeyDown_2(this$static, e){
  ...
  if (next != null) {
    ...
    $scrollIntoView_0(this$static.tree, next);
  }
}
...
function $onKeyUp_1(this$static, e){
  ...
  if (prev != null) {
    ...
    $scrollIntoView_0(this$static.tree, prev);
  }
}
...
defineSeed(1379, 1284, makeCastMap([Q$HasHandlers, Q$StoreSelectionModel]), TreeSelectionModel_0);
...
defineSeed(1380, 583, {}, TreeSelectionModel$1_0);
...
defineSeed(1381, 1, makeCastMap([Q$ClickHandler, Q$MouseDownHandler, Q$EventHandler]), TreeSelectionModel$Handler_0);
...
defineSeed(1441, 463, makeCastMap([Q$Collection, Q$List]));
...
defineSeed(1472, 1441, makeCastMap([Q$Serializable, Q$Collection, Q$List]), LinkedList_0, LinkedList_1);
...
defineSeed(1473, 1, makeCastMap([Q$Iterator, Q$ListIterator]), LinkedList$ListIteratorImpl_0);
...
defineSeed(1474, 1, {}, LinkedList$Node_0, LinkedList$Node_1);
_.next = null;
_.prev = null;
_.value_0 = null;
var Lcom_crud_client_presenter_LayoutPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'LayoutPresenter', 16), Lcom_crud_client_presenter_MenuPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter', 22), Lcom_crud_client_presenter_MenuPresenter$1_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter$1', 23), Lcom_crud_client_view_LayoutView_2_classLit = createForClass('com.crud.client.view.', 'LayoutView', 63), Lcom_gwtplatform_mvp_client_proxy_RevealRootContentEvent_2_classLit = createForClass('com.gwtplatform.mvp.client.proxy.', 'RevealRootContentEvent', 504), Lcom_crud_client_view_MenuView_2_classLit = createForClass('com.crud.client.view.', 'MenuView', 67), Lcom_crud_client_view_MenuView$KeyProvider_2_classLit = createForClass('com.crud.client.view.', 'MenuView$KeyProvider', 69), Lcom_crud_client_view_MenuView$1_2_classLit = createForClass('com.crud.client.view.', 'MenuView$1', 68), Lcom_crud_client_view_LayoutView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl', 64), Lcom_crud_client_view_LayoutView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl$Widgets', 65), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator', 44), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator$1', 45), Lcom_sencha_gxt_data_shared_event_StoreAddEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreAddEvent', 621), Lcom_sencha_gxt_data_shared_event_StoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreRemoveEvent', 627), Lcom_sencha_gxt_widget_core_client_container_Viewport_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'Viewport', 1199), Lcom_crud_client_view_MenuView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl', 70), Lcom_crud_client_view_MenuView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl$Widgets', 71), Lcom_sencha_gxt_data_shared_TreeStore_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore', 618), Lcom_sencha_gxt_data_shared_TreeStore$TreeModel_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$TreeModel', 620), Lcom_sencha_gxt_data_shared_TreeStore$1_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$1', 619), Lcom_crud_client_util_MenuDto_2_classLit = createForClass('com.crud.client.util.', 'MenuDto', 62), Lcom_sencha_gxt_widget_core_client_tree_Tree_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree', 1375), Lcom_sencha_gxt_widget_core_client_tree_Tree$TreeNode_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$TreeNode', 1378), Lcom_sencha_gxt_widget_core_client_tree_Tree$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$Handler', 1377), Lcom_sencha_gxt_widget_core_client_tree_Tree$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$1', 1376), Lcom_sencha_gxt_widget_core_client_event_BeforeExpandItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeExpandItemEvent', 1207), Lcom_sencha_gxt_widget_core_client_event_BeforeCollapseItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeCollapseItemEvent', 1205), Lcom_sencha_gxt_widget_core_client_event_CheckChangedEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'CheckChangedEvent', 1219), Lcom_sencha_gxt_widget_core_client_tree_TreeStyle_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeStyle', 1382), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel', 1379), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$Handler', 1381), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$1', 1380), Lcom_sencha_gxt_theme_base_client_tree_TreeBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.tree.', 'TreeBaseAppearance', 896), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance', 1072), Ljava_util_AbstractSequentialList_2_classLit = createForClass('java.util.', 'AbstractSequentialList', 1441), Ljava_util_LinkedList_2_classLit = createForClass('java.util.', 'LinkedList', 1472), Ljava_util_LinkedList$ListIteratorImpl_2_classLit = createForClass('java.util.', 'LinkedList$ListIteratorImpl', 1473), Ljava_util_LinkedList$Node_2_classLit = createForClass('java.util.', 'LinkedList$Node', 1474), Lcom_sencha_gxt_data_shared_event_TreeStoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'TreeStoreRemoveEvent', 630), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_1BlueTreeResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1', 1074), Lcom_sencha_gxt_widget_core_client_tree_TreeView_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeView', 1383), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance', 736), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_1ViewportResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1', 738), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer', 1173), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$Handler', 1182), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$3_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$3', 1176), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$4_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$4', 1177), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$5_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$5', 1178), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$6_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$6', 1179), Lcom_google_gwt_uibinder_client_LazyDomElement_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'LazyDomElement', 336), Lcom_google_gwt_event_dom_client_ClickEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'ClickEvent', 257), Lcom_google_gwt_uibinder_client_UiBinderUtil$TempAttachment_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'UiBinderUtil$TempAttachment', 338), Lcom_sencha_gxt_theme_base_client_container_BorderLayoutBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'BorderLayoutBaseAppearance', 723), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance', 917), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_1BlueBorderLayoutResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1', 919);
$entry(onLoad_1)(3);
