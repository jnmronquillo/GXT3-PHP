...
defineSeed(262, 263, {}, ClickEvent_0);
...
defineSeed(512, 5, {}, RevealRootContentEvent_0);
...
defineSeed(631, 617, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$Store, Q$TreeStore]), TreeStore_0);
...
defineSeed(632, 1, {}, TreeStore$1_0);
...
defineSeed(633, 1, makeCastMap([Q$TreeStore$TreeModel]), TreeStore$TreeModel_0);
_.data = null;
_.isVisible = true;
_.parent_0 = null;
_.root = false;
...
defineSeed(634, 635, {}, StoreAddEvent_0);
...
defineSeed(643, 640, makeCastMap([Q$TreeStoreRemoveEvent]), TreeStoreRemoveEvent_0);
_.children_0 = null;
_.parent_0 = null;
defineSeed(736, 1, {});
_.style_0 = null;
...
defineSeed(749, 1, {}, ViewportDefaultAppearance_0);
var style_7 = null;
function ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0(){
}

defineSeed(751, 1, {}, ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1_0);
...
function $template_2(){
  var outer, sb;
  outer = (sb = new StringBuilder_0 , sb.impl.string += '<div class="' , $append_10(sb, htmlEscape('GN1NA3IBJQ')) , sb.impl.string += '"><\/div>' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string));
  return outer;
}
...
function $onCheckChange(node, checkElement, checkable, state){
  ...
  if (checkable) {
    switch (state) {
      case 0:
        e = $getImage(($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$checkedInitializer() , checked_10));
        break;
      case 2:
        e = $getImage(($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$uncheckedInitializer() , unchecked_9));
        break;
      case 1:
...
defineSeed(942, 736, {}, BlueBorderLayoutAppearance_0);
var css_6 = null;
...
defineSeed(944, 1, {}, BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1_0);
...
function BlueTreeAppearance_0(){
  this.style_0 = ($clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$styleInitializer() , style_62);
  $ensureInjected_9(this.style_0);
}

defineSeed(1147, 921, {}, BlueTreeAppearance_0);
var checked_10 = null, folderClosed = null, folderOpened = null, jointCollapsedIcon = null, jointExpandedIcon = null, partialChecked = null, style_62 = null, unchecked_9 = null;
...
defineSeed(1149, 1, {}, BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1_0);
...
function $clinit_BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$styleInitializer(){
  ...
  style_62 = new BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1_0;
}
...
defineSeed(1251, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$3_0);
...
defineSeed(1252, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$4_0);
...
defineSeed(1253, 1, makeCastMap([Q$EventHandler, Q$SelectEvent$SelectHandler]), BorderLayoutContainer$5_0);
...
defineSeed(1254, 1, makeCastMap([Q$EventHandler, Q$SplitBarDragEvent$SplitBarDragHandler]), BorderLayoutContainer$6_0);
_.this$0 = null;
_.val$c = null;
_.val$data = null;
_.val$fbar = null;
...
defineSeed(1256, 1, makeCastMap([Q$HasMargins]), MarginData_0);
function BorderLayoutContainer$Handler_0(this$0){
  this.this$0 = this$0;
}

defineSeed(1257, 1, makeCastMap([Q$EventHandler, Q$BeforeCollapseEvent$BeforeCollapseHandler, Q$BeforeExpandEvent$BeforeExpandHandler]), BorderLayoutContainer$Handler_0);
_.this$0 = null;
...
defineSeed(1280, 5, makeCastMap([Q$CancellableEvent]), BeforeCollapseItemEvent_0);
...
defineSeed(1282, 5, makeCastMap([Q$CancellableEvent]), BeforeExpandItemEvent_0);
...
defineSeed(1294, 5, {}, CheckChangedEvent_0);
...
function $within(this$static, element){
  ...
  if (!!element && element.nodeType == 1) {
    target = $eventGetTarget(this$static);
    if (is_1(target)) {
...
function $onClick_4(this$static, event_0){
  ...
  e = event_0;
  node = $findNode(this$static, $eventGetTarget(event_0));
  if (node) {
...
_.onBrowserEvent = function onBrowserEvent_22(event_0){
  ...
  switch ($eventGetTypeInt(event_0.type)) {
    case 1:
      ...
      break;
    case 2:
      node = $findNode(this, $eventGetTarget(event_0));
...
defineSeed(1452, 1, makeCastMap([Q$EventHandler, Q$StoreAddEvent$StoreAddHandler, Q$StoreDataChangeEvent$StoreDataChangeHandler, Q$StoreFilterEvent$StoreFilterHandler, Q$StoreRemoveEvent$StoreRemoveHandler]), Tree$Handler_0);
...
defineSeed(1453, 1, makeCastMap([Q$Tree$TreeNode]), Tree$TreeNode_0);
_.checkElement = null;
_.checked_0 = 2;
...
function $onMouseClick(this$static, e){
  ...
  if (this$static.selectionMode == 2) {
    node = $findNode(this$static.tree, $eventGetTarget(e));
...
defineSeed(1454, 1359, makeCastMap([Q$HasHandlers, Q$StoreSelectionModel]), TreeSelectionModel_0);
...
defineSeed(1455, 596, {}, TreeSelectionModel$1_0);
...
defineSeed(1456, 1, makeCastMap([Q$ClickHandler, Q$MouseDownHandler, Q$EventHandler]), TreeSelectionModel$Handler_0);
...
function $onMouseOver_1(this$static, ne){
  var node;
  node = $getNode(this$static, $eventGetTarget(ne));
  if (node) {
...
defineSeed(1516, 471, makeCastMap([Q$Collection, Q$List]));
...
defineSeed(1547, 1516, makeCastMap([Q$Serializable, Q$Collection, Q$List]), LinkedList_0, LinkedList_1);
...
defineSeed(1548, 1, makeCastMap([Q$Iterator, Q$ListIterator]), LinkedList$ListIteratorImpl_0);
...
defineSeed(1549, 1, {}, LinkedList$Node_0, LinkedList$Node_1);
_.next = null;
_.prev = null;
_.value_0 = null;
var Lcom_crud_client_presenter_LayoutPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'LayoutPresenter', 16), Lcom_crud_client_presenter_MenuPresenter_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter', 22), Lcom_crud_client_presenter_MenuPresenter$1_2_classLit = createForClass('com.crud.client.presenter.', 'MenuPresenter$1', 23), Lcom_crud_client_view_LayoutView_2_classLit = createForClass('com.crud.client.view.', 'LayoutView', 63), Lcom_gwtplatform_mvp_client_proxy_RevealRootContentEvent_2_classLit = createForClass('com.gwtplatform.mvp.client.proxy.', 'RevealRootContentEvent', 512), Lcom_crud_client_view_MenuView_2_classLit = createForClass('com.crud.client.view.', 'MenuView', 67), Lcom_crud_client_view_MenuView$KeyProvider_2_classLit = createForClass('com.crud.client.view.', 'MenuView$KeyProvider', 69), Lcom_crud_client_view_MenuView$1_2_classLit = createForClass('com.crud.client.view.', 'MenuView$1', 68), Lcom_crud_client_view_LayoutView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl', 64), Lcom_crud_client_view_LayoutView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'LayoutView_BinderImpl$Widgets', 65), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator', 44), Lcom_crud_client_resources_Resources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.crud.client.resources.', 'Resources_default_InlineClientBundleGenerator$1', 45), Lcom_sencha_gxt_data_shared_event_StoreAddEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreAddEvent', 634), Lcom_sencha_gxt_data_shared_event_StoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'StoreRemoveEvent', 640), Lcom_sencha_gxt_widget_core_client_container_Viewport_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'Viewport', 1274), Lcom_crud_client_view_MenuView_1BinderImpl_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl', 70), Lcom_crud_client_view_MenuView_1BinderImpl$Widgets_2_classLit = createForClass('com.crud.client.view.', 'MenuView_BinderImpl$Widgets', 71), Lcom_sencha_gxt_data_shared_TreeStore_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore', 631), Lcom_sencha_gxt_data_shared_TreeStore$TreeModel_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$TreeModel', 633), Lcom_sencha_gxt_data_shared_TreeStore$1_2_classLit = createForClass('com.sencha.gxt.data.shared.', 'TreeStore$1', 632), Lcom_crud_client_util_MenuDto_2_classLit = createForClass('com.crud.client.util.', 'MenuDto', 62), Lcom_sencha_gxt_widget_core_client_tree_Tree_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree', 1450), Lcom_sencha_gxt_widget_core_client_tree_Tree$TreeNode_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$TreeNode', 1453), Lcom_sencha_gxt_widget_core_client_tree_Tree$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$Handler', 1452), Lcom_sencha_gxt_widget_core_client_tree_Tree$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'Tree$1', 1451), Lcom_sencha_gxt_widget_core_client_event_BeforeExpandItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeExpandItemEvent', 1282), Lcom_sencha_gxt_widget_core_client_event_BeforeCollapseItemEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'BeforeCollapseItemEvent', 1280), Lcom_sencha_gxt_widget_core_client_event_CheckChangedEvent_2_classLit = createForClass('com.sencha.gxt.widget.core.client.event.', 'CheckChangedEvent', 1294), Lcom_sencha_gxt_widget_core_client_tree_TreeStyle_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeStyle', 1457), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel', 1454), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$Handler', 1456), Lcom_sencha_gxt_widget_core_client_tree_TreeSelectionModel$1_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeSelectionModel$1', 1455), Lcom_sencha_gxt_theme_base_client_tree_TreeBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.tree.', 'TreeBaseAppearance', 921), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance', 1147), Ljava_util_AbstractSequentialList_2_classLit = createForClass('java.util.', 'AbstractSequentialList', 1516), Ljava_util_LinkedList_2_classLit = createForClass('java.util.', 'LinkedList', 1547), Ljava_util_LinkedList$ListIteratorImpl_2_classLit = createForClass('java.util.', 'LinkedList$ListIteratorImpl', 1548), Ljava_util_LinkedList$Node_2_classLit = createForClass('java.util.', 'LinkedList$Node', 1549), Lcom_sencha_gxt_data_shared_event_TreeStoreRemoveEvent_2_classLit = createForClass('com.sencha.gxt.data.shared.event.', 'TreeStoreRemoveEvent', 643), Lcom_sencha_gxt_theme_blue_client_tree_BlueTreeAppearance_1BlueTreeResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.tree.', 'BlueTreeAppearance_BlueTreeResources_default_InlineClientBundleGenerator$1', 1149), Lcom_sencha_gxt_widget_core_client_tree_TreeView_2_classLit = createForClass('com.sencha.gxt.widget.core.client.tree.', 'TreeView', 1458), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance', 749), Lcom_sencha_gxt_theme_base_client_container_ViewportDefaultAppearance_1ViewportResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'ViewportDefaultAppearance_ViewportResources_default_InlineClientBundleGenerator$1', 751), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer', 1248), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$Handler_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$Handler', 1257), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$3_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$3', 1251), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$4_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$4', 1252), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$5_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$5', 1253), Lcom_sencha_gxt_widget_core_client_container_BorderLayoutContainer$6_2_classLit = createForClass('com.sencha.gxt.widget.core.client.container.', 'BorderLayoutContainer$6', 1254), Lcom_google_gwt_uibinder_client_LazyDomElement_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'LazyDomElement', 341), Lcom_google_gwt_event_dom_client_ClickEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'ClickEvent', 262), Lcom_google_gwt_uibinder_client_UiBinderUtil$TempAttachment_2_classLit = createForClass('com.google.gwt.uibinder.client.', 'UiBinderUtil$TempAttachment', 343), Lcom_sencha_gxt_theme_base_client_container_BorderLayoutBaseAppearance_2_classLit = createForClass('com.sencha.gxt.theme.base.client.container.', 'BorderLayoutBaseAppearance', 736), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance', 942), Lcom_sencha_gxt_theme_blue_client_container_BlueBorderLayoutAppearance_1BlueBorderLayoutResources_1default_1InlineClientBundleGenerator$1_2_classLit = createForClass('com.sencha.gxt.theme.blue.client.container.', 'BlueBorderLayoutAppearance_BlueBorderLayoutResources_default_InlineClientBundleGenerator$1', 944);
$entry(onLoad_1)(3);
