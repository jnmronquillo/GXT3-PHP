...
function WelcomeView_0(){
  ...
  this.widget = (f_ContentPanel1 = new ContentPanel_0 , $setWidget_0(f_ContentPanel1, (f_CenterLayoutContainer2 = new CenterLayoutContainer_0 , $setWidget_0(f_CenterLayoutContainer2, new HTMLPanel_0((sb = new StringBuilder_0 , sb.impl.string += '<h2> Welcome User <\/h2>' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html)) , f_CenterLayoutContainer2)) , $setText_2(f_ContentPanel1.header, 'Welcome') , f_ContentPanel1);
}
